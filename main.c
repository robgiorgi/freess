...
#define PROG_PRESEN     \
   ...
   "v1.1 - Released 29-Oct-25 "
#define PROG_PRESEN2    \
   "FREESS v1.1 - Released 29-Oct-25 "
#define PROG_ULINE      \
   "-------------------------------------------------------------------"
...
static char	clv7[MAXLINELEN] = "no";
static char	clv8[MAXLINELEN] = "8";
static char	clv9[MAXLINELEN] = "24";
static char	clv10[MAXLINELEN] = "FDPIXWC";
static char	clv11[MAXLINELEN] = "yes";
static char	clv12[MAXLINELEN] = "yes";
static char	clv13[MAXLINELEN] = "no";
static char	clv14[MAXLINELEN] = "no";
static char	clv15[MAXLINELEN] = "yes";
static char	clv16[MAXLINELEN] = "yes";
static char	clv17[MAXLINELEN] = "yes";
static char	clv18[MAXLINELEN] = "4";
static char	clv19[MAXLINELEN] = "4";
static char	clv20[MAXLINELEN] = "4";
static char	clv21[MAXLINELEN] = "4";
static char	clv22[MAXLINELEN] = "4";
static char	clv23[MAXLINELEN] = "4";
static char	clv24[MAXLINELEN] = "16";
static char	clv25[MAXLINELEN] = "16";
static char	clv26[MAXLINELEN] = "4";
static char	clv27[MAXLINELEN] = "0";
static char	clv28[MAXLINELEN] = "100";
static char	clv29[MAXLINELEN] = "1";
static char	clv30[MAXLINELEN] = "4";
static char	clv31[MAXLINELEN] = "yes";
static char	clv32[MAXLINELEN] = "100";
static char	clv33[MAXLINELEN] = "1";
static char	clv34[MAXLINELEN] = "4";
static char	clv35[MAXLINELEN] = "yes";
static char	clv36[MAXLINELEN] = "100";
static char	clv37[MAXLINELEN] = "4";
static char	clv38[MAXLINELEN] = "1";
static char	clv39[MAXLINELEN] = "1";
static char	clv40[MAXLINELEN] = "2";
static char	clv41[MAXLINELEN] = "yes";
static char	clv42[MAXLINELEN] = "1";
static char	clv43[MAXLINELEN] = "1";
static char	clv44[MAXLINELEN] = "yes";
static char	clv45[MAXLINELEN] = "no";
static char	clv46[MAXLINELEN] = "100";
static char	clv47[MAXLINELEN] = "1";
static char	clv48[MAXLINELEN] = "0";
static char	clv49[MAXLINELEN] = "100";
static char	clv50[MAXLINELEN] = "1";
static char	clv51[MAXLINELEN] = "1";
static char	clv52[MAXLINELEN] = "yes";
static char	clv53[MAXLINELEN] = "0";
static char	clv54[MAXLINELEN] = "def.log";
...
static struct option long_options[] =
{
  ...
  {"rsrel", required_argument, NULL, 0},
  {"mempipe", required_argument, NULL, 0},
...
static IniSection GeneralSec[] =
{
   ...
   "Tomasulo Mode",			YES_NO,	0,	0,	&G.tomasulo,
   "",					ENDING,	0,	0,	NULL
};
...
static IniSection ArchitectureSec[] =
{
   ...
   "Early RS Release",			YES_NO,	0,	0,	&AA.early_rs_rel,
   "Data Mem. Pipe",			YES_NO,	0,	0,	&AA.mem_pipe,
...
int MainConstr(int argc, char **argv)
{
   ...
   while (1) {
      ...
      case 0: /* Long-named option. */
         ...
         if (strcmp("tom", long_options[option_index].name) == 0)
         ...
         if (strcmp("rsrel", long_options[option_index].name) == 0)
            if (optarg) { strcpy(clv16, optarg); ok = 1; }
         if (strcmp("mempipe", long_options[option_index].name) == 0)
         ...
         if (strcmp("spec", long_options[option_index].name) == 0)
            if (optarg) { strcpy(clv52, optarg); ok = 1; }
         if (strcmp("wblat	", long_options[option_index].name) == 0)
            if (optarg) { strcpy(clv53, optarg); ok = 1; }
         if (strcmp("logfile", long_options[option_index].name) == 0)
            if (optarg) { strcpy(clv54, optarg); ok = 1; }
   ...
   strcat(iniv, "tomasulo="); strcat(iniv, clv7); strcat(iniv, ";");
   strcat(iniv, "lregs="); strcat(iniv, clv8); strcat(iniv, ";");
   strcat(iniv, "pregs="); strcat(iniv, clv9); strcat(iniv, ";");
   strcat(iniv, "pipestruct="); strcat(iniv, clv10); strcat(iniv, ";");
   strcat(iniv, "uni_lsu="); strcat(iniv, clv11); strcat(iniv, ";");
   strcat(iniv, "load_has_pri="); strcat(iniv, clv12); strcat(iniv, ";");
   strcat(iniv, "io_issue="); strcat(iniv, clv13); strcat(iniv, ";");
   strcat(iniv, "io_complete="); strcat(iniv, clv14); strcat(iniv, ";");
   strcat(iniv, "uni_di="); strcat(iniv, clv15); strcat(iniv, ";");
   strcat(iniv, "early_rs_rel="); strcat(iniv, clv16); strcat(iniv, ";");
   strcat(iniv, "mem_pipe="); strcat(iniv, clv17); strcat(iniv, ";");
   strcat(iniv, "f_width="); strcat(iniv, clv18); strcat(iniv, ";");
   strcat(iniv, "d_width="); strcat(iniv, clv19); strcat(iniv, ";");
   strcat(iniv, "p_width="); strcat(iniv, clv20); strcat(iniv, ";");
   strcat(iniv, "i_width="); strcat(iniv, clv21); strcat(iniv, ";");
   strcat(iniv, "w_width="); strcat(iniv, clv22); strcat(iniv, ";");
   strcat(iniv, "c_width="); strcat(iniv, clv23); strcat(iniv, ";");
   strcat(iniv, "win_size="); strcat(iniv, clv24); strcat(iniv, ";");
   strcat(iniv, "rob_size="); strcat(iniv, clv25); strcat(iniv, ";");
   strcat(iniv, "int_fu="); strcat(iniv, clv26); strcat(iniv, ";");
   strcat(iniv, "a_lat="); strcat(iniv, clv27); strcat(iniv, ";");
   strcat(iniv, "a_rs="); strcat(iniv, clv28); strcat(iniv, ";");
   strcat(iniv, "im_fu="); strcat(iniv, clv29); strcat(iniv, ";");
   strcat(iniv, "im_lat="); strcat(iniv, clv30); strcat(iniv, ";");
   strcat(iniv, "im_pipe="); strcat(iniv, clv31); strcat(iniv, ";");
   strcat(iniv, "im_rs="); strcat(iniv, clv32); strcat(iniv, ";");
   strcat(iniv, "id_fu="); strcat(iniv, clv33); strcat(iniv, ";");
   strcat(iniv, "id_lat="); strcat(iniv, clv34); strcat(iniv, ";");
   strcat(iniv, "id_pipe="); strcat(iniv, clv35); strcat(iniv, ";");
   strcat(iniv, "id_rs="); strcat(iniv, clv36); strcat(iniv, ";");
   strcat(iniv, "fp_fu="); strcat(iniv, clv37); strcat(iniv, ";");
   strcat(iniv, "fm_fu="); strcat(iniv, clv38); strcat(iniv, ";");
   strcat(iniv, "l_fu="); strcat(iniv, clv39); strcat(iniv, ";");
   strcat(iniv, "l_lat="); strcat(iniv, clv40); strcat(iniv, ";");
   strcat(iniv, "l_pipe="); strcat(iniv, clv41); strcat(iniv, ";");
   strcat(iniv, "s_fu="); strcat(iniv, clv42); strcat(iniv, ";");
   strcat(iniv, "s_lat="); strcat(iniv, clv43); strcat(iniv, ";");
   strcat(iniv, "s_pipe="); strcat(iniv, clv44); strcat(iniv, ";");
   strcat(iniv, "s_waits="); strcat(iniv, clv45); strcat(iniv, ";");
   strcat(iniv, "ls_rs="); strcat(iniv, clv46); strcat(iniv, ";");
   strcat(iniv, "b_fu="); strcat(iniv, clv47); strcat(iniv, ";");
   strcat(iniv, "b_lat="); strcat(iniv, clv48); strcat(iniv, ";");
   strcat(iniv, "b_rs="); strcat(iniv, clv49); strcat(iniv, ";");
   strcat(iniv, "lqsize="); strcat(iniv, clv50); strcat(iniv, ";");
   strcat(iniv, "sqsize="); strcat(iniv, clv51); strcat(iniv, ";");
   strcat(iniv, "speculation="); strcat(iniv, clv52); strcat(iniv, ";");
   strcat(iniv, "wblat="); strcat(iniv, clv53); strcat(iniv, ";");
   strcat(iniv, "logfile="); strcat(iniv, clv54); strcat(iniv, ";");
   ...
   G.tomasulo = (0 == strcmp(clv7, "yes") ? 1 : 0);
   IsNumVal(clv8, &(AA.lregs));;
   IsNumVal(clv9, &(AA.pregs));;
   strcpy(AA.pipestruct, clv10);
   AA.uni_lsu = (0 == strcmp(clv11, "yes") ? 1 : 0);
   AA.load_has_pri = (0 == strcmp(clv12, "yes") ? 1 : 0);
   AA.io_issue = (0 == strcmp(clv13, "yes") ? 1 : 0);
   AA.io_complete = (0 == strcmp(clv14, "yes") ? 1 : 0);
   AA.uni_di = (0 == strcmp(clv15, "yes") ? 1 : 0);
   AA.early_rs_rel = (0 == strcmp(clv16, "yes") ? 1 : 0);
   AA.mem_pipe = (0 == strcmp(clv17, "yes") ? 1 : 0);
   IsNumVal(clv18, &(AA.f_width));;
   IsNumVal(clv19, &(AA.d_width));;
   IsNumVal(clv20, &(AA.p_width));;
   IsNumVal(clv21, &(AA.i_width));;
   IsNumVal(clv22, &(AA.w_width));;
   IsNumVal(clv23, &(AA.c_width));;
   IsNumVal(clv24, &(AA.win_size));;
   IsNumVal(clv25, &(AA.rob_size));;
   IsNumVal(clv26, &(AA.int_fu));;
   IsNumVal(clv27, &(AA.a_lat));;
   IsNumVal(clv28, &(AA.a_rs));;
   IsNumVal(clv29, &(AA.im_fu));;
   IsNumVal(clv30, &(AA.im_lat));;
   AA.im_pipe = (0 == strcmp(clv31, "yes") ? 1 : 0);
   IsNumVal(clv32, &(AA.im_rs));;
   IsNumVal(clv33, &(AA.id_fu));;
   IsNumVal(clv34, &(AA.id_lat));;
   AA.id_pipe = (0 == strcmp(clv35, "yes") ? 1 : 0);
   IsNumVal(clv36, &(AA.id_rs));;
   IsNumVal(clv37, &(AA.fp_fu));;
   IsNumVal(clv38, &(AA.fm_fu));;
   IsNumVal(clv39, &(AA.l_fu));;
   IsNumVal(clv40, &(AA.l_lat));;
   AA.l_pipe = (0 == strcmp(clv41, "yes") ? 1 : 0);
   IsNumVal(clv42, &(AA.s_fu));;
   IsNumVal(clv43, &(AA.s_lat));;
   AA.s_pipe = (0 == strcmp(clv44, "yes") ? 1 : 0);
   AA.s_waits = (0 == strcmp(clv45, "yes") ? 1 : 0);
   IsNumVal(clv46, &(AA.ls_rs));;
   IsNumVal(clv47, &(AA.b_fu));;
   IsNumVal(clv48, &(AA.b_lat));;
   IsNumVal(clv49, &(AA.b_rs));;
   IsNumVal(clv50, &(AA.lqsize));;
   IsNumVal(clv51, &(AA.sqsize));;
   AA.speculation = (0 == strcmp(clv52, "yes") ? 1 : 0);
   IsNumVal(clv53, &(AA.wblat));;
   strcpy(Pro.logfile, clv54);
...
\n\
  ...
  -tom <tomasulo_mode>		  Tomasulo Pipeline + RS (no)\n\
  ...
  -rsrel <early_rs_release>	  Early RS Release (yes)\n\
  -mempipe <data_mem._pipe>	  Pipelined Data Mempry (yes)\n\
